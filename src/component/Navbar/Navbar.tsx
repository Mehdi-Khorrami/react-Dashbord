...
const NavButton = ({ tittle, customFun, icon, color, dotColor }) => {
  return (
    <Tooltip title={tittle} >
      <Button type='button' onClick={customFun} style={{ color: color }}>
        <Typography component='span' style={{ background: dotColor }}>
          {icon}
        </Typography>
      </Button>
    </Tooltip>
    ...
    <Box className='Navbar'>
      ...
      <Box style={{ display: "flex", flexWrap: "wrap" }}>
        ...
        <Tooltip title="profils">
          <div className='Avatar' onClick={() => handleClick('profils')}>
